...
import importedNativeCode from '@/../node_modules/@zemkit/label/src/label.tsx?raw';
import importedWebCode from '@/../node_modules/@zemkit/label/src/label.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@zemkit/label/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@zemkit/label/src/index.ts?raw';
...
function Example() {
  ...
  return (
    <Label.Root>
      <Label.Text nativeID='to-be-use-by-aria-labelledby-from-form-field'>Label</Label.Text>
    </Label.Root>
  );
}
```
