...
import importedNativeCode from '@/../node_modules/@zemkit/radio-group/src/radio-group.tsx?raw';
import importedWebCode from '@/../node_modules/@zemkit/radio-group/src/radio-group.web.tsx?raw';
import importedTypesCode from '@/../node_modules/@zemkit/radio-group/src/types.ts?raw';
import importedIndexCode from '@/../node_modules/@zemkit/radio-group/src/index.ts?raw';
  ...
  return (
    <RadioGroupPrimitive.Root value={value} onValueChange={setValue}>
      <View>
        ...
        <Text nativeID='default-label' onPress={onLabelPress('Default')}>
          Default
        </Text>
      </View>
      <View>
        ...
        <Text nativeID='comfortable-label' onPress={onLabelPress('Comfortable')}>
          Comfortable
        </Text>
      </View>
      <View>
        ...
        <Text nativeID='compact-label' onPress={onLabelPress('Compact')}>
          Compact
        </Text>
      </View>
