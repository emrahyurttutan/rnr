...
import importedCode from '@zemkit/reusables/components/ui/accordion?raw';

<LinkButton href='/primitives/accordion'>Accordion Primitive</LinkButton>
...
<Aside type='tip' title='Dependencies'>
  ...
  <a href='/primitives/accordion' className='text-white font-bold'>
    accordion primitive
  </a>{' '}
  and the{' '}
