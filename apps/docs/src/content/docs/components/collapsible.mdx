...
import importedCode from '@zemkit/reusables/components/ui/collapsible?raw';

<LinkButton href='/primitives/collapsible'>Collapsible Primitive</LinkButton>
...
<Aside type='tip' title='Dependency'>
  ...
  <a href='/primitives/collapsible' className='text-white font-bold'>
