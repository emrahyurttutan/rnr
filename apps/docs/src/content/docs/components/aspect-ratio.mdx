...
import importedCode from '@zemkit/reusables/components/ui/aspect-ratio?raw';

<LinkButton href='/primitives/aspect-ratio'>Aspect-Ratio Primitive</LinkButton>
...
<Aside type='tip' title='Dependency'>
  ...
  <a href='/primitives/aspect-ratio' className='text-white font-bold'>
