...
import importedCode from '@zemkit/reusables/components/ui/alert-dialog?raw';
...
<Aside type='tip' title='Dependencies'>
  ...
  <a href='/primitives/alert-dialog' className='text-white font-bold'>
    {' '}
    alert-dialog primitive
  </a>
  , the{' '}
  <a href='/components/button' className='text-white font-bold'>
    button component
  </a>
  , and the{' '}
