...
import importedCode from '@zemkit/reusables/components/ui/separator?raw';

<LinkButton href='/primitives/separator'>Separator Primitive</LinkButton>
...
<Aside type='tip' title='Dependencies'>
  ...
  <a href='/primitives/separator' className='text-white font-bold'>
    {' '}
    separator primitive
  </a>{' '}
  to your project.
