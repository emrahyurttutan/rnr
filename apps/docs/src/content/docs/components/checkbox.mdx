...
import importedCode from '@zemkit/reusables/components/ui/checkbox?raw';

<LinkButton href='/primitives/checkbox'>Checkbox</LinkButton>
...
<Aside type='tip' title='Dependency'>
  ...
  <a href='/primitives/checkbox' className='text-white font-bold'>
    checkbox primitive
  </a>{' '}
  to your project.
</Aside>
