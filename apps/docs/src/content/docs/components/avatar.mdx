...
import importedCode from '@zemkit/reusables/components/ui/avatar?raw';

<LinkButton href='/primitives/avatar'>Avatar Primitive</LinkButton>
...
<Aside type='tip' title='Dependency'>
  ...
  <a href='/primitives/avatar' className='text-white font-bold'>
    avatar primitive
  </a>{' '}
  to your project.
</Aside>
