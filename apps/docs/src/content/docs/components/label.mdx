...
import importedCode from '@zemkit/reusables/components/ui/label?raw';

<LinkButton href='/primitives/label'>Label</LinkButton>
...
<Aside type='tip' title='Dependency'>
  ...
  <a href='/primitives/label' className='text-white font-bold'>
    label primitive
  </a>{' '}
  to your project.
</Aside>
